...
class CheckBoxPage(BasePage):
    ...
    def click_random_checkbox(self):
        item_list = self.elements_ere_visible(self.locators.ITEM_LIST)
        count = 21
        while count != 0:
    ...
    def get_checked_checkboxes(self):
        checked_list = self.elements_ere_present(self.locators.CHECKED_ITEMS)
        data = []
...
class WebTablePage(BasePage):
    ...
    def new_person(self):
        people_list = self.elements_ere_present(self.locators.FULL_PEOPLE_LIST)
        data = []
